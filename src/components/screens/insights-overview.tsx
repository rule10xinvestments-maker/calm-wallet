...
function SpendingMixSummaryChart({
  ...
  return (
    <div className="grid gap-4 rounded-lg border border-slate-100 bg-slate-50/70 p-3 sm:grid-cols-[180px_1fr] sm:items-center">
      ...
      <div className="space-y-2" aria-label={`${segment === "income" ? "Income" : "Expenses"} category legend`}>
        {chart.items.map((item) => (
          <div key={item.key} className="grid grid-cols-[auto_1fr_auto] items-center gap-2 rounded-md bg-white px-2.5 py-2 shadow-sm">
