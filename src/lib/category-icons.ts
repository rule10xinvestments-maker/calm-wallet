...
export const CATEGORY_VISUALS_BY_NAME: Record<string, CategoryVisuals> = {
  ...
  investments: { icon: TrendingUp, primary: "#0F766E", bg: "#CCFBF1", border: "#5EEAD4" },
  "investment income": { icon: TrendingUp, primary: "#0F766E", bg: "#CCFBF1", border: "#5EEAD4" },
  sales: { icon: Store, primary: "#7C3AED", bg: "#EDE9FE", border: "#C4B5FD" },
  "rental income": { icon: Building2, primary: "#0369A1", bg: "#E0F2FE", border: "#7DD3FC" },
  "side income": { icon: Coins, primary: "#9333EA", bg: "#F3E8FF", border: "#D8B4FE" },
