...
export function areRewardedCreditsEnabled() {
  return process.env.NEXT_PUBLIC_REWARDED_CREDITS_ENABLED === "true" || process.env.REWARDED_CREDITS_ENABLED === "true";
}

export function areCreditPacksEnabled() {
  return process.env.NEXT_PUBLIC_CREDIT_PACKS_ENABLED === "true" || process.env.CREDIT_PACKS_ENABLED === "true";
}

export function isYearlyUnlimitedEnabled() {
  return process.env.NEXT_PUBLIC_YEARLY_UNLIMITED_ENABLED === "true" || process.env.YEARLY_UNLIMITED_ENABLED === "true";
}
